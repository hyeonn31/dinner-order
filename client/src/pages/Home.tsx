    ...
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="text-center mb-12">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium mb-6"
          style={{ background: "oklch(0.88 0.07 75 / 0.3)", color: "oklch(0.45 0.10 65)", border: "1px solid oklch(0.72 0.12 75 / 0.3)" }}>
          <Clock className="w-4 h-4" />
          매일 오후 4시 ~ 6시 운영
        </div>
        <h1 className="text-4xl font-bold mb-3" style={{ color: "oklch(0.18 0.02 30)", fontFamily: "'Playfair Display', serif" }}>
          저녁식사 신청 시스템
        </h1>
        <p className="text-lg" style={{ color: "oklch(0.52 0.02 30)" }}>
      ...
      <div className="rounded-2xl p-6 mb-8 text-center"
        ...
        {hasSetup ? (
          ...
          <div className="text-sm" style={{ color: "oklch(0.52 0.02 30)" }}>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <Link href="/order">
          <div className="group rounded-2xl p-6 cursor-pointer transition-all duration-200 hover:-translate-y-1"
            ...
            <div className="w-12 h-12 rounded-xl flex items-center justify-center mb-4"
              ...
              <UtensilsCrossed className="w-6 h-6" style={{ color: "oklch(0.72 0.12 75)" }} />
            </div>
            <h3 className="font-semibold text-base mb-1" style={{ color: "oklch(0.18 0.02 30)" }}>저녁 신청</h3>
            <p className="text-sm mb-4" style={{ color: "oklch(0.52 0.02 30)" }}>메뉴를 선택하고 신청하세요</p>
            <div className="flex items-center gap-1 text-sm font-medium" style={{ color: "oklch(0.45 0.10 65)" }}>
        ...
        <Link href="/admin">
          <div className="group rounded-2xl p-6 cursor-pointer transition-all duration-200 hover:-translate-y-1"
            ...
            <div className="w-12 h-12 rounded-xl flex items-center justify-center mb-4"
              style={{ background: "oklch(0.22 0.04 30)" }}>
              <Settings className="w-6 h-6" style={{ color: "oklch(0.72 0.12 75)" }} />
            </div>
            <h3 className="font-semibold text-base mb-1" style={{ color: "oklch(0.18 0.02 30)" }}>관리자</h3>
            <p className="text-sm mb-4" style={{ color: "oklch(0.52 0.02 30)" }}>오늘의 식당을 설정하세요</p>
            <div className="flex items-center gap-1 text-sm font-medium" style={{ color: "oklch(0.45 0.10 65)" }}>
        ...
        <Link href="/summary">
          <div className="group rounded-2xl p-6 cursor-pointer transition-all duration-200 hover:-translate-y-1"
            ...
            <div className="w-12 h-12 rounded-xl flex items-center justify-center mb-4"
              style={{ background: "oklch(0.22 0.04 30)" }}>
              <BarChart3 className="w-6 h-6" style={{ color: "oklch(0.72 0.12 75)" }} />
            </div>
            <h3 className="font-semibold text-base mb-1" style={{ color: "oklch(0.18 0.02 30)" }}>주문 취합</h3>
            <p className="text-sm mb-4" style={{ color: "oklch(0.52 0.02 30)" }}>신청 현황을 확인하세요</p>
            <div className="flex items-center gap-1 text-sm font-medium" style={{ color: "oklch(0.45 0.10 65)" }}>
