...
const menuItems = [
  ...
  // 오미마리 (4)녁식사 안해용"]
  ...["신선 김밥 닭강정 세트", "참치 김밥 닭강정 세트", "크래미 김밥 닭강정 세트", "씨앗멸치 김밥 닭강정 세트", "스팸 김밥 닭강정 세트", "치즈계란 김밥 닭강정 세트", "와사마요 불고기 김밥 닭강정 세트", "지단 김밥 닭강정 세트", "닭강정(소)"].map((n, i) => ({ restaurantId: 4, name: n, itemType: "main", sortOrder: i + 1 })),
